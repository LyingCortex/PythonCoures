...
def compPlayHand(hand, wordList, n):
    ...
    while calculateHandlen(handcopy): 
        ...
        if word in wordList:
            c_s =getWordScore(word, n)
            total_score += c_s
        
            print '"' + word +'"' +' earned '+ str(c_s)+' points. Total:'+str(total_score)+' points'
...
def playGame(wordList):
    ...
    while 1:
        ...
        if choice == 'n':
            ...
            round_label = 0
            while 1:
                ch_uc = raw_input("Enter u to have yourself play, c to have the computer play: ")
                if ch_uc == 'u':
